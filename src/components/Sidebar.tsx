...
const navItems = [
  { icon: Globe, label: 'Get Started', path: '/get-started', isActive: false },
  { icon: LayoutDashboard, label: 'Dashboard', path: '/', isActive: true },
  { icon: CreditCard, label: 'Accounts', path: '/accounts', isActive: false },
  { icon: ArrowUpDown, label: 'Transfers', path: '/transfers', isActive: false },
  { icon: Receipt, label: 'Transactions', path: '/transactions', isActive: false },
  { icon: Settings, label: 'Settings', path: '/settings', isActive: false },
];
